...
\newcommand{\ArchName}{x86}
\newcommand{\ARCHNAME}{X86}
\newcommand{\ISRL}{\code{sarq}}
\newcommand{\INEG}{\code{negq}}
\newcommand{\IXOR}{\code{xorq}}
\newcommand{\IAND}{\code{andq}}
\newcommand{\IADD}{\code{addq}}
\newcommand{\ISUB}{\code{subq}}
\newcommand{\ICALL}{\code{callq}}
\newcommand{\IMOVE}{\code{movq}}
\newcommand{\RET}{\code{retq}}
\newcommand{\SP}{\code{rsp}}
\newcommand{\FP}{\code{rbp}}
\newcommand{\RAX}{\code{rax}}
\newcommand{\ROOTSP}{\code{r15}}
\newcommand{\ILEA}{\code{leaq}}
\newcommand{\FIVE}{5}
\newcommand{\SIX}{6}
\fi
\if\architecture\riscvEd
\newcommand{\ArchName}{RISC-V}
\newcommand{\ARCHNAME}{RISCV}
\newcommand{\ISRL}{\code{srl}}
\newcommand{\INEG}{\code{neg}}
\newcommand{\IXOR}{\code{xor}}
\newcommand{\IADD}{\code{add}}
\newcommand{\IAND}{\code{and}}
\newcommand{\ISUB}{\code{sub}}
\newcommand{\ICALL}{\code{call}}
\newcommand{\IMOVE}{\code{mv}}
\newcommand{\RET}{\code{ret}}
\newcommand{\SP}{\code{sp}}
\newcommand{\FP}{\code{fp}}
\newcommand{\RAX}{\code{a0}}
\newcommand{\ROOTSP}{\code{s11}}
\newcommand{\ILEA}{\code{la}}
\newcommand{\FIVE}{7}
\newcommand{\SIX}{8}
\fi

\newcommand{\LangXVar}{$\mathrm{{\ArchName}}_{\mathsf{Var}}$} % pseudo {\ArchName}_0
\newcommand{\LangXASTInt}{\ensuremath{\mathrm{{\ArchName}}_{\mathsf{Int}}}} % {\ArchName}_0
\newcommand{\LangXInt}{$\mathrm{{\ArchName}}_{\mathsf{Int}}$} %{\ArchName}^{\dagger}_0
\newcommand{\LangXIntM}{\mathrm{{\ArchName}}_{\mathsf{Int}}} %{\ArchName}^{\dagger}_0
\newcommand{\LangXASTIf}{\ensuremath{\mathrm{{\ArchName}}_{\mathsf{If}}}} %{\ArchName}_1
\newcommand{\LangXIf}{$\mathrm{{\ArchName}}_{\mathsf{If}}$} %{\ArchName}^{\dagger}_1
\newcommand{\LangXIfM}{\mathrm{{\ArchName}}_{\mathsf{If}}} %{\ArchName}^{\dagger}_1
\newcommand{\LangXIfVar}{\ensuremath{\mathrm{{\ArchName}}^{\mathsf{Var}}_{\mathsf{If}}}} %{\ArchName}^{*}_1
\newcommand{\LangXASTGlobal}{\ensuremath{\mathrm{{\ArchName}}_{\mathsf{Global}}}} %{\ArchName}_2
\newcommand{\LangXGlobal}{$\mathrm{{\ArchName}}_{\mathsf{Global}}$} %{\ArchName}^{\dagger}_2
\newcommand{\LangXGlobalM}{\mathrm{{\ArchName}}_{\mathsf{Global}}} %{\ArchName}^{\dagger}_2
\newcommand{\LangXGlobalVar}{\ensuremath{\mathrm{{\ArchName}}^{\mathsf{Var}}_{\mathsf{Global}}}} %{\ArchName}^{*}_2
\newcommand{\LangXIndCall}{$\mathrm{{\ArchName}}^{\mathsf{Def}}_{\mathsf{callq*}}$} %{\ArchName}_3
\newcommand{\LangXIndCallM}{\mathrm{{\ArchName}}^{\mathsf{Def}}_{\mathsf{callq*}}} %{\ArchName}_3
\newcommand{\LangXIndCallFlat}{$\mathrm{{\ArchName}}_{\mathsf{callq*}}$} %{\ArchName}_3
\newcommand{\LangXIndCallFlatM}{\mathrm{{\ArchName}}_{\mathsf{callq*}}} %{\ArchName}_3
\newcommand{\LangXIndCallVar}{\ensuremath{\mathrm{{\ArchName}}^{\mathsf{Var},\mathsf{Def}}_{\mathsf{callq*}}}} %{\ArchName}^*_3
...
\newcommand{\XPROGRAM}[2]{\LP\code{{\ARCHNAME}Program}~#1~#2\RP}
\newcommand{\XPROGRAMDEFS}[2]{\LP\code{{\ARCHNAME}ProgramDefs}~#1~#2\RP}
...
\newcommand{\TERINSTR}[4]{\key{Instr}\LP #1 \key{,} \LS #2 \key{,} #3 \key{,} #4 \RS \RP}
...
\fi
\if\architecture\riscvEd
\newcommand{\INDCALLQ}[2]{\key{IndirectCall}\LP#1\code{, }#2\RP}
\newcommand{\JMPIF}[4]{\key{JumpIf}\LP #1 \key{,} #2 \key{,} #3 \key{,} #4 \RP}
\newcommand{\SETIF}[3]{\key{SetIf}\LP #1 \key{,} #2  \key{,} #3 \RP}
\newcommand{\CALLQ}[2]{\key{Call}\LP #1 \key{,} #2 \RP}
\newcommand{\RETQ}{\key{Instr}\LP \skey{ret} \key{,} \LS \RS \RP}
\fi
% TODO: change \XPROGRAM to 1 parameter
\newcommand{\XPROGRAM}[2]{\code{{\ARCHNAME}Program}\LP #2 \RP}
\newcommand{\XPROGRAMDEFS}[1]{\code{{\ARCHNAME}ProgramDefs}\LP #1 \RP}

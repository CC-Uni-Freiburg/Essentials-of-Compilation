...
\begin{center}
  \begin{lstlisting}
mainstart: {}, block5: {i}, block7: {i, sum}, block8: {sp, sum}
\end{lstlisting}
\end{center}
\fi}
...
\begin{center}
  \begin{lstlisting}
mainstart: {}, block5: {i, sp, sum}, block7: {i, sum}, block8: {sp, sum}
\end{lstlisting}
\end{center}
\fi}
...
\begin{center}
  \begin{lstlisting}
mainstart: {sp}, block5: {i,sp,sum}, block7: {i,sp,sum}, block8: {sp,sum}
\end{lstlisting}
\end{center}
\fi}
...
(section~\ref{sec:tail-call}), we arrange never to need more than \ifxeightsix{six}\ifriscv{eight}
arguments.
%
...
\ifxeightsix{prefixed with an asterisk}\ifriscv{source}.  We recommend using \RAX{} to hold the
...
\code{TailJmp} is {\RAX}, our reserved register---because we

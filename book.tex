...
itself.) For the \ifxeightsix{\key{callq}}\ifriscv{\key{call}} instruction, we consider all the
...
\ifxeightsix{\key{movq}}\ifriscv{\key{mv}} there is the special case
of two variables holding the same 

...
\Arg &::=&  \IMM{\Int} \MID \REG{\Reg}
   \MID \DEREF{\Reg}{\Int} \\
  \Instr &::=& \TERINSTR{\scode{add}}{\Reg}{\Reg}{\Reg}
               \MID \TERINSTR{\scode{sub}}{\Reg}{\Reg}{\Reg} \\
     &\MID& \TERINSTR{\scode{addi}}{\Reg}{\Reg}{\Int} 
            \MID \BININSTR{\scode{neg}}{\Reg}{\Reg} \\
            &\MID& \BININSTR{\scode{mv}}{\Reg}{\Reg}
...
\fi}
\end{tcolorbox}
\caption{The abstract syntax of \LangXInt{} assembly.\ifriscv{CONSTRUCTION}}
...
\begin{lstlisting}
    ...
    sd a0, -24(fp)
\end{lstlisting}
After transforming the remaining move instruction, we obtain a legal
{\ArchName} program.
\begin{lstlisting}
    li a0, 42
    sd a0, -24(fp)
    ...
    call print_int
\end{lstlisting}
Clearly, the last store instruction is redundant, but we leave its
